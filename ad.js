/*
更新于  2019年1月14日 00:21:38
*/

var proxy = "PROXY 106.185.26.199:25;";//翻墙代理IP地址
//var proxy = "PROXY 52.32.111.83:8888";
...
"174.129.40.147"
//=========IP地址End=========
//【在分行里可以追加IP，两边加上双引号，使用逗号分隔。】
    ]

    var rules = [
//【iOS9以上的部分系统由于系统限制，无法享受规则功能。】
//=========规则Start=========
"https://www.66sstt.com/js/*.js",
"*88rrss.com/js/ddd-index.js",
"*88rrss.com/js/ddd.js",
...
function FindProxyForURL(url, host) {
    if (host == "test.test") {
        return "PROXY setwood.cn:80";
    }
	for (n in others){
      if(dnsDomainIs(host, others[n])){
      return "PROXY setwood.cn:80";
      }
    }
	for (n in ips){
